...
attn_group.add_argument("--use-intel-hpu-attention", action="store_true", help="Use intel hpu FusedSDPA.")
attn_group.add_argument("--use-intel-hpu-fa3", action="store_true", help="Use intel hpu FA3.")
